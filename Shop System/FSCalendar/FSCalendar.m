...
- (void)initialize
{
    ...
    //daysContainer.userInteractionEnabled = NO;
...
- (void)layoutSubviews
{
    ...
    _daysContainer.frame = CGRectMake(_daysContainer.frame.origin.x, _daysContainer.frame.origin.y, _daysContainer.frame.size.width, _daysContainer.frame.size.height - 1);
    _supressEvent = NO;
}
...
- (void)scrollToDate:(NSDate *)date animated:(BOOL)animated
{
    ...
    animated &= YES;//_scrollEnabled; // No animation if _scrollEnabled == NO;
