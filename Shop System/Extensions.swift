...
extension UIColor {
    ...
    class func tabBarBlueColor() -> UIColor {
        return UIColor(hexString: "03A9F4")
    }
    
    class func backColor() -> UIColor {
        return UIColor(hexString: "EDF3F7")
    }
    
    class func darkBlueTextColor() -> UIColor {
        return UIColor(hexString: "323B46")
    }
    
    class func lightBlueTextColor() -> UIColor {
        return UIColor(hexString: "6C7B8A")
    }
    ...
    class func orangeFill() -> UIColor {
        return UIColor(hexString: "E77C6E")
    }
}
